      ...
      <div className="w-full flex flex-col items-center justify-center space-y-5 ">
        ...
        {redirecting && (
          <div className="flex flex-col items-center justify-center my-8">
            <ThreeDots visible={true} height="40" width="80" color="#3B82F6" radius="9" ariaLabel="three-dots-loading" />
            <span className="mt-4 text-primary dark:text-white text-lg font-bold">جاري التحويل ...</span>
          </div>
        )}
        {!redirecting && (
